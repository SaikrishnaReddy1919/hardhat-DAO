...
This repo is meant to give you all the knowledge you need to start a DAO and do governance.
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://github.com/SaikrishnaReddy1919/hardhat-DAO.git)
...
1. Clone this repo:
```
git clone https://github.com/SaikrishnaReddy1919/hardhat-DAO.git
```
...
4. Add a `.env` file with the same contents of `.env.example`, but replace with your variables.
